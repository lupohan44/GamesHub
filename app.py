...
def main(argv):
    ...
    for dirs in os.listdir(os.path.join(os.path.dirname(__file__), 'plugins')):
        if os.path.isdir(os.path.join(os.path.dirname(__file__), "plugins", dirs)):
    ...
    for plugin_name in enabled_plugins:
        if plugin_name in folders_under_plugins:
            enabled_plugins_folders.append(os.path.join(os.path.dirname(__file__), "plugins", plugin_name))
